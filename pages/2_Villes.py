...
def display_kpi_metrics2(ville_data, indicateur):
    ...
    for indicator in indicateur:
        if "Taux" in indicator or "Part" in indicator or "Température" in indicator or "Température" in indicator or "Précipitations" in indicator or "Loyer" in indicator or "vent" in indicator:
